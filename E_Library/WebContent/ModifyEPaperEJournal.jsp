...
<head>
	...
	<meta name="author"      content="Sanil Jain">
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Modify E-Publish</h1>
				</header>
...
PreparedStatement pst=con.prepareStatement("select * from epublish e,ematerialsbasemaster m where e.id=m.id and e.id=?");
		...
		if(rs.next())
			...
			%>
							...
							<div class="row top-margin">
								...
								<div class="top-margin">
								<label>Year</label>
								  <input type="text" class="form-control" name="year" value=<%=rs.getString("year") %>>
								</div>
								<div class="top-margin">
								<label>Month</label>
								  <input type="text" class="form-control" name="month" value=<%=rs.getString("month") %>>
								</div>
								
								<div class="top-margin">
								<br/>
								<label>Frequency</label>
								  <input type="text" class="form-control" name="frequency" <%=rs.getString("frequency") %>>
								</div>
