		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Modify E-Book</h1>
				</header>
...
PreparedStatement pst=con.prepareStatement("select * from ebook e,ematerialsbasemaster m where e.id=m.id and e.id=?");
		...
		if(rs.next())
			...
			%>
						...
						<div class="top-margin">	 
										<label>ISBN-10</label>
										  <input type="text" class="form-control" name="isbnTen" value=<%=rs.getString("isbn_10") %>>
										</div>
								
								<div class="top-margin">
								<label>ISBN-13</label>
										  <input type="text" class="form-control" name="isbnThirteen" value=<%=rs.getString("isbn_13") %>>
										</div>
