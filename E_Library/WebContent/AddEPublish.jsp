		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Add E-PUBLISH</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
						<form action="AddEPublishServlet" method="post" enctype="multipart/form-data">
						...
						<%@ include file="EMaterialCommon.jsp"%>
								...
								<div class="top-margin">
								<label>Year</label>
								  <input  class="form-control validate[required]" type="text" name="year">
								</div>
								<div class="top-margin">
								<label>Month</label>
								  <input  class="form-control validate[required]" type="text" name="month">
								</div>
								
								<div class="top-margin">
								<br/>
								<label>Frequency</label>
								  <input  class="form-control validate[required] " type="text" name="frequency">
								</div>
