		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Modify E-Projects</h1>
				</header>
...
PreparedStatement pst=con.prepareStatement("select * from eproject e,ematerialsbasemaster m where e.id=m.id and e.id=?");
		...
		if(rs.next())
			...
			%>
						...
						<div class="top-margin">	 
										<label>Topic</label>
										  <input type="text" class="form-control" name="topic" value=<%=rs.getString("topic") %>>
										</div>
								
								<div class="top-margin">
								<label>Type</label>
										  <input type="text" class="form-control" name="type" value=<%=rs.getString("type") %>>
										</div>
										
								<div class="top-margin">
								<label>TOP</label>
										  <input type="text" class="form-control" name="top" value=<%=rs.getString("top") %>>
										</div>
