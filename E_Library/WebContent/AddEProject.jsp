		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Add E-Project</h1>
				</header>
				
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<form action="AddEProjectServlet" method="post" id="formID"enctype="multipart/form-data">
						...
						<%@ include file="EMaterialCommon.jsp"%>
								...
								<div class="top-margin">	 
										<label>Topic</label>
										  <input  class="form-control validate[required] text-input" type="text"  name="topic">
										</div>
								
								<div class="top-margin">
								<label>Type</label>
										  <input class="form-control validate[required] text-input" type="text" name="type">
										</div>
										
								<div class="top-margin">
								<label>TOP</label>
										  <input  class="form-control validate[required] " type="text" name="top">
										</div>
								<div class="top-margin">
								
								<label>File</label>
								<input class="form-control validate[required] " type="file" name="fn" />
