...
<head>
	...
	<title>Add Faculty Resources</title>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Add E-FacultyResources</h1>
				</header>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						...
						<form action="AddEFacultyResourceServlet" id="formID" method="post" enctype="multipart/form-data">
						<%@ include file="EMaterialCommon.jsp" %>
							 
						<div class="top-margin">
						<label>Department</label>
						<input   class="form-control validate[required] text-input" type="text" name="department" />
						</div>
								
						<div class="top-margin">
						<label>Semester</label>
						<input  class="form-control validate[required] " name="semester" type="text"/>
						</div>
